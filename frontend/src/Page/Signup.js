        ...
        <div className='p-3 md:p-4'>
            <div className='w-full max-w-sm bg-white m-auto flex items-center flex-col p-4 rounded'>
                ...
                <form className='py-2 w-full flex flex-col' onSubmit={handleSubmit}>
                    ...
                    <button  className='w-full max-w-[120px] m-auto bg-blue-500 hover:bg-orange-600 cursor-pointer text-xl text-white font-medium text-center py-1 rounded-full mt-4'>Sign up</button>
                </form>
